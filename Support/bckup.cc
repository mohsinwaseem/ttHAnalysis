...
MyNtupleMaker::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   for(Int_t iGenJet=0; iGenJet<nGenJet; iGenJet++)
     {
       ...
       // vector<Double_t> jetgenPt;
       // vector<Double_t> jetgenEta;
       // vector<Double_t> jetgenPhi;
       // vector<Double_t> jetgenE;
   ...
   //****************************************************************************
	...
	Jet_bDis_JBP.push_back(tempjet.bDiscriminator("jetBProbabilityBJetTags"));
	Jet_bDis_JP.push_back(tempjet.bDiscriminator("jetProbabilityBJetTags"));
	Jet_bDis_TCHP.push_back(tempjet.bDiscriminator("trackCountingHighPurBJetTags"));
	Jet_bDis_TCHE.push_back(tempjet.bDiscriminator("trackCountingHighEffBJetTags"));
	Jet_bDis_SVHP.push_back(tempjet.bDiscriminator("simpleSecondaryVertexHighEffBJetTags"));
	Jet_bDis_SVHE.push_back(tempjet.bDiscriminator("simpleSecondaryVertexHighPurBJetTags"));
	Jet_bDis_CMVA.push_back(tempjet.bDiscriminator("combinedMVABJetTags"));
	...
	int   tempgen_jet_status = -666;
	int   tempgen_jet_id = -666;
	...
	if( hasGenInfo )
	  {
	     ...
	     tempgen_jet_status = tempgenJet->status();
	     tempgen_jet_id     = tempgenJet->pdgId();
	  }
	...
	Jet_GenJet_Status.push_back (tempgen_jet_status);
	Jet_GenJet_PdgId.push_back  (tempgen_jet_id);
